...
! function ($) {
	...
	SEMICOLON.initialize = {
			...
			$sliderEl.each(function () {
				if ($(this).hasClass("swiper_wrapper")) {
					...
					if (swiperSlider = new Swiper(element.find(".swiper-parent"), {
						...
						for (var prop in sliderSettings) swiperSlider.params[prop] = sliderSettings[prop], swiperSlider.update()
					}
				}
			})
		},
		...
		carousel: function () {
			...
			e.each(function () {
				var e = $(this),
					...
					E = 5e3,
					x = !0;
				t || (t = 4), a || (a = Number(t)), i || (i = Number(a)), s || (s = Number(i)), o || (o = Number(s)), n || (n = Number(o)), d || (d = 250), p || (p = 20), m || (m = 0), v || (v = 0), b || (b = 1), b = "page" == b ? "page" : Number(b), r = "true" == r, l ? (E = Number(l), l = !0) : (l = !1, x = !1), c || (c = !1), u || (u = !1), f = "false" != f, h = "false" != h, C = "true" == C, g = "true" == g, y = "true" == y, O = "true" == O, w = "true" == w, S = !("true" != S && !$body.hasClass("rtl")), e.owlCarousel({
					margin: Number(p),
					loop: r,
		...
		windowscroll: function () {
			var e = 0,
				t = 0;
			$header.length > 0 && $header.offset().top, $header.length > 0 && (e = $headerWrap.offset().top), $pagemenu.length > 0 && (t = $header.length > 0 && !$header.hasClass("no-sticky") ? $header.hasClass("sticky-style-2") || $header.hasClass("sticky-style-3") ? $pagemenu.offset().top - $headerWrap.outerHeight() : $pagemenu.offset().top - $header.outerHeight() : $pagemenu.offset().top);
